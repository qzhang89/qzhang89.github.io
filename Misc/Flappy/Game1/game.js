...
Game.prototype.update = function() {
    ...
    if (bird.alive) {
        ...
        if (bird.y+bird.height+bird.velocity+1 >= comingPipe.openDn) {
            bird.flap();
        }
        bird.update();
    ...
    // Animate
    this.display(comingPipe.openDn);
    var self = this;
...
Game.prototype.display = function(marker) {
    var ctxt  = this.ctxt;
    var bird  = this.bird;
    var pipes = this.pipes;
    ...
    ctxt.lineWidth = 3;
    ctxt.beginPath();
    ctxt.moveTo(0, marker);
    ctxt.lineTo(this.canvas.width, marker);
    ctxt.stroke();
